...
pub fn render(app: &App, frame: &mut Frame, area: Rect, theme: &Theme) {
    match &app.mode {
        ...
        Mode::PromptNewSession { input } => {
            render_input_prompt("New Session", "Enter session name:", input, frame, area, theme)
        }
        ...
        Mode::PromptRenameWindow { input, .. } => {
            render_input_prompt("Rename Window", "Enter new name:", input, frame, area, theme)
        }
...
fn render_confirm_kill(target: &KillTarget, frame: &mut Frame, area: Rect, theme: &Theme) {
    ...
    let prompt_line = Line::from(vec![
        Span::styled(" [y/Enter] ", Style::default().bg(Color::Red).fg(Color::White).add_modifier(Modifier::BOLD)),
        Span::raw(" Confirm Kill   "),
        Span::styled(" [n/Esc] ", Style::default().bg(Color::DarkGray).fg(Color::White)),
        Span::raw(" Cancel"),
    ]);
...
fn render_help(frame: &mut Frame, area: Rect, theme: &Theme) {
    ...
    let help_text = vec![
        Line::from(vec![Span::styled("GLOBAL NAVIGATION", Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD))]),
        Line::from(vec![Span::styled("  h / l, ← / →, Tab     ", Style::default().fg(Color::Cyan)), Span::raw("Switch column focus (Sessions, Windows, Panes)")]),
        Line::from(vec![Span::styled("  j / k, ↓ / ↑          ", Style::default().fg(Color::Cyan)), Span::raw("Move selection up / down")]),
        Line::from(vec![Span::styled("  Enter                 ", Style::default().fg(Color::Cyan)), Span::raw("Focus selection / Attach to workspace")]),
        Line::from(vec![Span::styled("  /                     ", Style::default().fg(Color::Cyan)), Span::raw("Global fuzzy search (sessions, windows, panes)")]),
        Line::from(vec![Span::styled("  r                     ", Style::default().fg(Color::Cyan)), Span::raw("Force refresh tmux state")]),
        Line::from(vec![Span::styled("  ?                     ", Style::default().fg(Color::Cyan)), Span::raw("Toggle this help modal")]),
        Line::from(vec![Span::styled("  q / Esc               ", Style::default().fg(Color::Cyan)), Span::raw("Quit LazyTmux")]),
        Line::raw(""),
        Line::from(vec![Span::styled("ACTIONS BY COLUMN", Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD))]),
        Line::from(vec![Span::styled("  n                     ", Style::default().fg(Color::Green)), Span::raw("New session (in Sessions) / New window (in Windows)")]),
        Line::from(vec![Span::styled("  R                     ", Style::default().fg(Color::Green)), Span::raw("Rename selected session / window")]),
        Line::from(vec![Span::styled("  x                     ", Style::default().fg(Color::Red)), Span::raw("Kill selected session / window / pane (with confirm)")]),
        Line::from(vec![Span::styled("  f                     ", Style::default().fg(Color::Yellow)), Span::raw("Toggle favorite on selected session")]),
        Line::from(vec![Span::styled("  z                     ", Style::default().fg(Color::Cyan)), Span::raw("Toggle zoom on selected pane")]),
        Line::from(vec![Span::styled("  c                     ", Style::default().fg(Color::Cyan)), Span::raw("Copy pane output to system clipboard")]),
        Line::from(vec![Span::styled("  Space                 ", Style::default().fg(Color::Cyan)), Span::raw("Open full-screen Inspect Mode for selected pane")]),
        Line::raw(""),
        Line::from(vec![Span::styled("INSPECT MODE (Space)", Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD))]),
        Line::from(vec![Span::styled("  j / k, Ctrl+d / Ctrl+u ", Style::default().fg(Color::Cyan)), Span::raw("Scroll up / down buffer history")]),
        Line::from(vec![Span::styled("  g / G                 ", Style::default().fg(Color::Cyan)), Span::raw("Jump to top / bottom")]),
        Line::from(vec![Span::styled("  c                     ", Style::default().fg(Color::Cyan)), Span::raw("Copy entire buffer to clipboard")]),
        Line::from(vec![Span::styled("  Esc / Space           ", Style::default().fg(Color::Cyan)), Span::raw("Exit inspect mode")]),
    ];
